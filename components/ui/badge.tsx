...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:border-neutral-800 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary text-neutral-50 hover:bg-primary dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/80",
        secondary:
        ...
        outline:
          "text-neutral-500 dark:text-neutral-50 border-accent bg-accent-secondary",
        primary: "bg-accent-secondary text-primary",
      },
    },
    defaultVariants: {
      variant: "default",
